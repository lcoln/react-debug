...
function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
  {
    ...
    if (warnAboutSpreadingKeyToJSX) {
      if (hasOwnProperty.call(props, 'key')) {
        error('React.jsx: Spreading a key to JSX is a deprecated pattern. ' + 'Explicitly pass a key after spreading props in your JSX call. ' + 'E.g. <%s {...props} key={key} />', getComponentNameFromType(type) || 'ComponentName');
      }
    }

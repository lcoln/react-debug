...
const getSuspenseInstanceFallbackErrorDetails = shim$1;
const registerSuspenseInstanceRetry = shim$1;
...
let ReactFabricHostComponent = /*#__PURE__*/function () {
  ...
  _proto.measure = function measure(callback) {
    const stateNode = this._internalInstanceHandle.stateNode;
  ...
  /* currently unused */
  {
    ...
    const fromStateNode = relativeToNativeNode._internalInstanceHandle.stateNode;
  ...
  _proto.removeEventListener_unstable = function removeEventListener_unstable(eventType, listener, options) {
    ...
    const optionsObj = typeof options === 'object' && options !== null ? options : {};
    const capture = (typeof options === 'boolean' ? options : optionsObj.capture) || false; // If there are no event listeners or named event listeners, we can bail early - our
    // job is already done.
...
function getCurrentEventPriority() {
  const currentEventPriority = fabricGetCurrentEventPriority ? fabricGetCurrentEventPriority() : null;
